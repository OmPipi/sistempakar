...
<div class="container">
  <div class="ocl-md-10 col-md-offset-1">
        ...
        <table width="100%"  cellpadding="5">
                ...
                <tr>
                    <td colspan="3" align="center">
                        <button name="submit" class="btn btn-success" onclick="popup('../controller/cetak.php?act=detail&user=<?php echo $username;?>&id=<?php echo $id;?>')" name="submit">Cetak</button></td>
                </tr>
            </table>
      </form>
      </div><!--panel body-->
    ...
    <div class="panel panel-default">
      ...
      <form action="javascript: void(0)" method="post" class="text-justify" padding-right="50px" cellpadding="5">
        <table width="100%"  cellpadding="5">
          ...
          <tr>
            <td colspan="3" align="center">
            <button name="submit" class="btn btn-success" onclick="popup('../controller/cetak0.php?user=<?php echo $username;?>&id=<?php echo $id;?>')" >Cetak</button></td>
          </tr>
        </table>
      </form>
      </div><!--panel body-->
